...
// middleware
const corsOptions = {
  origin: ["https://imgbb.com", "http://localhost:5173"], // specify the allowed origin(s)
...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.3frzyej.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
  try {
    ...
    //! Get the current user is admin or not
